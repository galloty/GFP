...
gfp6 is free source code, under the MIT license (see LICENSE). You can redistribute, use and/or modify it.
Please give feedback to the authors if improvement is realized. It is distributed in the hope that it will be useful.

gfp6 searches for Generalized Fermat Progressions with length >= 6: numbers b such that b^{2^k} + 1 are primes for k = 0...5.
...
static std::string header()
{
	...
	ss << "gfp6 1.0.0 " << sysver << ssc.str() << std::endl;
	ss << "Copyright (c) 2020, Yves Gallot" << std::endl;
	ss << "gfp6 is free source code, under the MIT license." << std::endl;
	ss << std::endl;
	return ss.str();
}
...
{
	std::ostringstream ss;
	ss << "Usage: gfp6 [b_min]    b_min is the start of the b search (in T (10^12) values, default 0)" << std::endl << std::endl;
	return ss.str();
}
...
static void output(const uint64_t b, const int n)
{
	...
	std::ofstream resFile("gfp6.log", std::ios::app);
	if (resFile.is_open())
	{
		resFile << b << std::endl;
		resFile.flush();
...
int main(int argc, char * argv[])
{
	...
	// weights: 13: 0.769231, 41: 0.829268, 7: 0.857143
	def_sieve(13); def_sieve(41); def_sieve(7);
	// weights: 449: 0.859688, 113: 0.867257, 577: 0.890815
	def_sieve(449); def_sieve(113); def_sieve(577);
	// weights: 29: 0.896552, 641: 0.901716, 73: 0.90411
	def_sieve(29); def_sieve(641); def_sieve(73);
	// weights: 11: 0.909091, 353: 0.912181, 769: 0.918075
	def_sieve(11); def_sieve(353); def_sieve(769);
	// weights: 37: 0.918919, 89: 0.921348, 241: 0.937759
	def_sieve(37); def_sieve(89); def_sieve(241);
	// weights: 53: 0.943396, 1153: 0.94536, 19: 0.947368
	def_sieve(53); def_sieve(1153); def_sieve(19);
	// weights: 1217: 0.948233, 137: 0.948905, 61: 0.95082
	def_sieve(1217); def_sieve(137); def_sieve(61);
	// weights: 673: 0.953938, 1409: 0.955287, 337: 0.95549
	def_sieve(673); def_sieve(1409); def_sieve(337);
	// weights: 23: 0.956522, 1601: 0.96065, 401: 0.962594
	def_sieve(23); def_sieve(1601); def_sieve(401);
	// weights: 433: 0.965358, 929: 0.966631, 31: 0.967742
	def_sieve(433); def_sieve(929); def_sieve(31);
	// weights: 233: 0.969957, 2113: 0.970185, 101: 0.970297
	def_sieve(233); def_sieve(2113); def_sieve(101);
	// weights: 109: 0.972477, 593: 0.974705, 281: 0.975089
	def_sieve(109); def_sieve(593); def_sieve(281);
	// weights: 1249: 0.97518, 2689: 0.976571, 43: 0.976744
	def_sieve(1249); def_sieve(2689); def_sieve(43);
	// weights: 2753: 0.977116, 313: 0.977636, 47: 0.978723
	def_sieve(2753); def_sieve(313); def_sieve(47);
	// weights: 149: 0.979866, 3137: 0.979917, 157: 0.980892
	def_sieve(149); def_sieve(3137); def_sieve(157);
